...
export default function Header() {
  ...
  return (
    <header className="flex justify-between items-center p-4 border-b-2 text-white sticky">
      <h1 className="text-xl font-bold">Mail Blitz</h1>
      <div className="relative">
        <button
          className={`flex flex-col items-center justify-center w-10 h-10 rounded-md transition-all duration-300 focus:outline-none bg-black ${
            isOpen
