...
export default function EmailTemplates({ navigateToPage }) {
  ...
  return (
    <div className="container">
      ...
      <div className="template-grid group relative overflow-hidden rounded-lg shadow-lg transition-all duration-300 ease-in-out hover:-translate-y-2 hover:shadow-xl">
