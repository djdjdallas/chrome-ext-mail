...
import { Webcam } from "lucide-react"; // Import the webcam icon
...
export default function CustomizeEmail() {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-4 md:px-6 py-6 md:py-20">
      ...
      <div className="mt-6 md:mt-16 grid grid-cols-1 md:grid-cols-2 gap-8">
